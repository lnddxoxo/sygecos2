...
<head>
    ...
    <title>SYGECOS - Mon Dossier Étudiant</title>
        ...
        <main class="main-content" id="mainContent">
            ...
            <div class="page-content">
                <div class="page-header">
                    <div>
                        <h1 class="page-title-main">Mon Dossier Étudiant</h1>
                        <p class="page-subtitle">Consultez et gérez vos informations personnelles et académiques</p>
                    </div>
                    <div>
                ...
                <div class="student-profile">
                    <div class="profile-card">
                        <div class="profile-header">
                            ...
                            <h3 class="profile-name"><?= htmlspecialchars($etudiant['prenoms_etu'] ?? '') . ' ' . htmlspecialchars($etudiant['nom_etu'] ?? '') ?></h3>
                            <div class="profile-id">N° étudiant: <?= htmlspecialchars($etudiant['num_etu'] ?? 'N/A') ?></div>
                            <span class="profile-badge"><?= htmlspecialchars($etudiant['lib_niv_etu'] ?? 'N/A') ?></span>
                        </div>
                        <div class="profile-details">
                            <div class="detail-item">
                                <span class="detail-label">Filière:</span>
                                <span class="detail-value"><?= htmlspecialchars($etudiant['lib_filiere'] ?? 'N/A') ?></span>
                            </div>
                            <div class="detail-item">
                                <span class="detail-label">Email:</span>
                                <span class="detail-value"><?= htmlspecialchars($etudiant['email_etu'] ?? 'N/A') ?></span>
                            </div>
                            <div class="detail-item">
                                <span class="detail-label">Login:</span>
                                <span class="detail-value"><?= htmlspecialchars($etudiant['login_util'] ?? 'N/A') ?></span>
                            </div>
                            <div class="detail-item">
                    ...
                    <div>
                        ...
                        <div class="info-card" style="margin-bottom: var(--space-6);">
                            <div class="info-card-header">
                                <h3 class="info-card-title">Statut Académique</h3>
                            ...
                            <div class="info-grid" style="grid-template-columns: repeat(2, 1fr);">
                                <div>
                                    <div class="detail-item">
                                        <span class="detail-label">Année d'inscription:</span>
                                        <span class="detail-value">2023-2024</span>
                                    </div>
                                    <div class="detail-item">
                                        <span class="detail-label">Statut:</span>
                                        <span class="detail-value"><span class="badge badge-success">Actif</span></span>
                                    </div>
                                </div>
                                <div>
                                    <div class="detail-item">
                                        <span class="detail-label">Crédits acquis:</span>
                                        <span class="detail-value">45/60</span>
                                    </div>
                                    <div class="detail-item">
                                        <span class="detail-label">Moyenne générale:</span>
                                        <span class="detail-value">14.25/20</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="info-card">
                            <div class="info-card-header">
                                <h3 class="info-card-title">Mes Documents</h3>
                                <div class="info-card-icon">
                ...
                <div class="table-container">
                    <div class="table-header">
                        <h3 class="table-title">
                            <i class="fas fa-clipboard-list"></i> Mes Évaluations Récentes
                        </h3>
