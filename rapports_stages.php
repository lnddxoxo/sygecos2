...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .modal-content { background-color: var(--white); margin: 2% auto; padding: 0; border-radius: var(--radius-xl); width: 90%; max-width: 800px; box-shadow: var(--shadow-xl); max-height: 90vh; overflow-y: auto; }
        ...
        .modal-footer { padding: var(--space-6); border-top: 1px solid var(--gray-200); display: flex; justify-content: flex-end; gap: var(--space-3); }
...
<body>
                    ...
                    <form id="filterForm">
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="search_term" name="search_term" placeholder="Nom, matricule, titre...">
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <textarea id="commentaireValidation" rows="4" placeholder="Commentaires sur le rapport..."></textarea>
                </div>
                <input type="hidden" id="rapportIdValidation">
            </div>
            <div class="modal-footer">
                <button class="btn btn-secondary" onclick="closeModal('validationModal')">Annuler</button>
    ...
    <div id="directeurModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Affecter un directeur de stage</h3>
                <span class="close" onclick="closeModal('directeurModal')">&times;</span>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label for="enseignantDirecteur">Enseignant</label>
                    <select id="enseignantDirecteur">
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" onclick="closeModal('directeurModal')">Annuler</button>
    ...
    <script>
        ...
        function affecterDirecteur(idRapport) {
            ...
            document.getElementById('directeurModal').style.display = 'block';
        }
