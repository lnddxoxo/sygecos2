<aside class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <div class="sidebar-logo">
            <img src="assets/images/logo-secretariat.png" alt="Secrétariat SYGECOS">
        </div>
        <span class="sidebar-title">Secrétariat</span>
    </div>
    ...
    <nav class="sidebar-nav">
        <div class="nav-section">
            ...
            <div class="nav-item">
                <a href="dashboard_secretaire.php" class="nav-link">
                    <div class="nav-icon">
        ...
        <div class="nav-section">
            <div class="nav-item">
                <a href="infos_secretaire.php" class="nav-link">
                    <div class="nav-icon">
        ...
        <div class="nav-section">
            ...
            <div class="nav-item">
                <a href="redaction_docs_secretaire.php" class="nav-link">
                    <div class="nav-icon">
                        <i class="fas fa-edit"></i>
                    </div>
                    <span class="nav-text">Rédaction de documents</span>
                </a>
            </div>
            <div class="nav-item">
                <a href="gestion_docs_secretaire.php" class="nav-link">
                    <div class="nav-icon">
                        <i class="fas fa-folder-open"></i>
                    </div>
                    <span class="nav-text">Gestion des documents</span>
                </a>
            </div>
        </div>
        ...
        <div class="nav-section">
            <div class="nav-item">
                <a href="messagerie_secretaire.php" class="nav-link">
                    <div class="nav-icon">
        ...
        <div class="nav-section">
            <div class="nav-item">
                <a href="parametres_secretaire.php" class="nav-link">
                    <div class="nav-icon">
