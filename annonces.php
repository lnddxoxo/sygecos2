        ...
        <main class="main-content" id="mainContent">
            ...
            <div class="page-content">
                <div class="page-header">
                    <div>
                        <h1 class="page-title-main">Annonces</h1>
                        <p class="page-subtitle">Restez informé des dernières actualités de l'établissement</p>
                    </div>
                </div>

                <div style="max-width: 800px; margin: 0 auto;">
                    <div class="announcement-item announcement-important">
                        <h3 class="announcement-title">⚠️ Modification des horaires d'examen</h3>
                        <div class="announcement-meta">
                            <span>Par: Administration</span>
                            <span>Date: 20/01/2024</span>
                        </div>
                        <div class="announcement-content">
                            <p>En raison d'un problème technique, l'examen de "Gestion de projet" initialement prévu le 25 janvier est reporté au 28 janvier à 10h dans l'amphithéâtre B.</p>
                            <p>Merci de votre compréhension.</p>
                        </div>
                    </div>

                    <div class="announcement-item">
                        <h3 class="announcement-title">Atelier de préparation aux stages</h3>
                        <div class="announcement-meta">
                            <span>Par: Service des stages</span>
                            <span>Date: 15/01/2024</span>
                        </div>
                        <div class="announcement-content">
                            <p>Un atelier de préparation à la recherche de stage aura lieu le 30 janvier de 14h à 16h en salle A12.</p>
                            <p>Au programme :</p>
                            <ul style="margin: var(--space-4) 0; padding-left: var(--space-6);">
                                <li>Rédaction de CV et lettre de motivation</li>
                                <li>Techniques d'entretien</li>
                                <li>Présentation des entreprises partenaires</li>
                            </ul>
                            <p>Inscription obligatoire auprès du service des stages.</p>
                        </div>
                    </div>

                    <div class="announcement-item">
                        <h3 class="announcement-title">Bibliothèque - Horaires modifiés</h3>
                        <div class="announcement-meta">
                            <span>Par: Bibliothèque</span>
                            <span>Date: 10/01/2024</span>
                        </div>
                        <div class="announcement-content">
                            <p>À partir du 15 janvier, la bibliothèque sera ouverte :</p>
                            <ul style="margin: var(--space-4) 0; padding-left: var(--space-6);">
                                <li>Lundi à vendredi : 8h-19h (au lieu de 8h-18h)</li>
                                <li>Samedi : 9h-13h (fermeture à 12h auparavant)</li>
                            </ul>
                        </div>
                    </div>
                </div>
