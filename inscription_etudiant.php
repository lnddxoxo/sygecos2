...
<body>
                    ...
                    <form id="inscriptionForm">
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="lieu_naissance" name="lieu_naissance" placeholder="Ex: Paris">
                            </div>
                            <div class="form-group">
                                <label for="email">Email <span style="color: var(--error-500);">*</span></label>
                                <input type="email" id="email" name="email" placeholder="Ex: jean.dupont@etudiant.univ.fr" required>
                            </div>
                            <div class="form-group">
    ...
    <script>
        // Script pour gérer l'inscription
