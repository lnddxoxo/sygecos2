<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <div class="nav-section">
            ...
            <div class="nav-item">
                <a href="dashboard_commission.php" class="nav-link">
                    <div class="nav-icon">
        ...
        <div class="nav-section">
            ...
            <div class="nav-item">
                <a href="info_membre_commission.php" class="nav-link">
                    <div class="nav-icon">
        ...
        <div class="nav-section">
            ...
            <div class="nav-item">
                <a href="rapports_deposes.php" class="nav-link">
                    <div class="nav-icon">
        ...
        <div class="nav-section">
            <div class="nav-section-title">Soutenance</div>
            <div class="nav-item">
                <a href="attributions.php" class="nav-link">
                    <div class="nav-icon">
            ...
            <div class="nav-item">
                <a href="planifications.php" class="nav-link">
                    <div class="nav-icon">
        ...
        <div class="nav-section">
            <div class="nav-section-title">Réunions</div>
            <div class="nav-item">
            ...
            <div class="nav-item">
                <a href="compte_rendu.php" class="nav-link active">
                    <div class="nav-icon">
            ...
            <div class="nav-item">
                <a href="mes_comptes_rendus.php" class="nav-link">
                    <div class="nav-icon">
                        <i class="fas fa-folder-open"></i> </div>
                    <span class="nav-text">Mes Comptes Rendus</span>
                </a>
            </div>
        </div>
