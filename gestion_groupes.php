            ...
            case 'delete':
                ...
                foreach ($idsGroupes as $idGU) {
                    ...
                    if ($checkUsage->fetchColumn() > 0) {
                        throw new Exception("Impossible de supprimer ce groupe car il est utilisé par des utilisateurs");
                    }
...
<head>
    ...
    <style>
        ...
        :root {
            ...
            /* Couleurs d'Accent Bleu (vos couleurs originales) */
            --accent-50: #eff6ff;
            --accent-100: #dbeafe;
            --accent-200: #bfdbfe;
            --accent-300: #93c5fd;
...
<body>
                ...
                <div class="table-card">
                    <div class="table-header">
                        ...
                        <div class="table-actions">
                            ...
                            <button class="btn btn-secondary" id="exporterGroupeBtn">
    ...
    <script>
        ...
        const exporterGroupeBtn = document.getElementById('exporterGroupeBtn');
        ...
        exporterGroupeBtn.addEventListener('click', function() {
            // Vérifier s'il y a des groupes à exporter
            const rows = document.querySelectorAll('#groupeTable tbody tr');
            if (rows.length === 1 && rows[0].querySelector('td[colspan="5"]')) {
                showAlert('Aucun groupe à exporter', 'warning');
                return;
            }
