...
<div class="sidebar">
    <div class="sidebar-header">
        <div class="sidebar-logo">
            <img src="assets/images/logo.png" alt="SYGECOS">
        </div>
        <div class="sidebar-title">SYGECOS</div>
    </div>
    ...
    <div class="sidebar-nav">
        <div class="nav-section">
            ...
            <div class="nav-item">
                <a href="doyen_infos.php" class="nav-link">
                    <div class="nav-icon"><i class="fas fa-user"></i></div>
                    <div class="nav-text">Informations Personnelles</div>
                </a>
            </div>
            <div class="nav-item">
                <a href="doyen_compte_rendu.php" class="nav-link">
                    <div class="nav-icon"><i class="fas fa-folder"></i></div>
                    <div class="nav-text">Comptes Rendus</div>
                </a>
            </div>
            <div class="nav-item">
                <a href="doyen_messagerie.php" class="nav-link">
        ...
        <div class="nav-section">
            ...
            <div class="nav-item">
                <a href="parametres_doyen.php" class="nav-link">
